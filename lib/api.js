...
var api = {
  ...
  process: function (req, res) {
    ...
    if (!modules.api[endpoint][reqMethod].hasOwnProperty('controller') || !modules.api[endpoint][reqMethod].hasOwnProperty('fn')) {
        res.send(500, { 'status': 'error', 'message': 'API error - Not Specified Correctly' });
        return;
    }

    // Set fn
    var fn = modules.api[endpoint][reqMethod].fn;
    ...
    // Set controller
    var controller = modules.controllers[endpoint];
    ...
    controller[fn].call(this, req, res);
