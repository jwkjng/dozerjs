...
_.mixin({
	...
	'updatePath': function(obj, fun, ks, defaultValue) {
      if (!_.isAssociative(obj)) throw new TypeError("Attempted to update a non-associative object.");
      if (!_.existy(ks)) return fun(obj);
	...
	'setPath': function(obj, value, ks, defaultValue) {
		if (!_.existy(ks)) throw new TypeError("Attempted to set a property at a null path.");
